...
oauth2_scheme = OAuth2PasswordBearer(tokenUrl="api/auth/login") # Змініть URL на ваш маршрут логіну
...
async def get_current_user(token: str = Depends(oauth2_scheme)):
    ...
    # У реальному застосунку тут слід отримати користувача з бази даних за email
    # і перевірити його існування та статус підтвердження
    return {"email": email} # Просто повертаємо email для прикладу
